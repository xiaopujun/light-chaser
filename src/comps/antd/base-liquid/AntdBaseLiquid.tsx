...
import {Gauge, Liquid, Rose} from "@ant-design/charts";

/**
 * 基础条形图
 */
export default class AntdBaseLiquid extends PureComponent<any> {
    ...
    render() {
        ...
        return (
            <CompBgContainer style={style?.baseStyle}>
                {
                    connect ? <Liquid supportCSSTransform={true} onGetG2Instance={(chart: any) => {
                            this.chart = chart;
