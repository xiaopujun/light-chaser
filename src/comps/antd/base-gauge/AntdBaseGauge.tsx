...
import {Gauge, Rose} from "@ant-design/charts";

/**
 * 基础条形图
 */
export default class AntdBaseGauge extends PureComponent<any> {
    ...
    render() {
        ...
        return (
            <CompBgContainer style={style?.baseStyle}>
                {
                    connect ? <Gauge supportCSSTransform={true} onGetG2Instance={(chart: any) => {
                            this.chart = chart;
