...
export default class CommonDragger extends AbstractDrag {
    ...
    constructor(target: HTMLElement, dragTarget: HTMLElement, initPos?: DragCoordinate) {
        super();
        this.target = target;
    ...
    protected onDragEnd = (): void => {
        this.dragTarget?.addEventListener('pointerup', (e: PointerEvent) => {
            if (e.button === 0) {
    ...
    protected onDragMove = (e: PointerEvent): void => {
    ...
    protected onDragStart = (): void => {
        this.dragTarget?.addEventListener('pointerdown', (e: PointerEvent) => {
            if (e.button === 0) {
