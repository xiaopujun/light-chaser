...
class LocalOperator extends AbstractOperator {
     ...
     * @param projectData
     */
    public async updateProject(projectData: ProjectDataType): Promise<boolean> {
        // if (projectData.id === '') {
        //     //没有id走创建流程
        ...
        // } else {
        //     //有id走更新流程
        //     const status = await this._updateProject(projectData);
    ...
    // }
    //
    // private async _updateProject(projectData: ProjectDataType): Promise<boolean> {
