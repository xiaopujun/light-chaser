        ...
        return (
            <div className={'lc-theme-config'}>
                <div className={'lc-theme-custom'}>
                    <Button type={'primary'} size={'middle'} style={{width: '100%'}}>+ 新增自定义主题</Button>
                </div>
                <br/>
                <div className={'lc-theme-list'}>
                    ...
                    <ThemeItem main={'#ffc0d9'} text={'#ff7cbf'} background={'#ff59aa'} auxiliary={'#ff3b8d'}
                               emphasize={'#ff0072'} supplementary={'#c3005a'}/>
